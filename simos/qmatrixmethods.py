...
def focker_to_dm(v,is_hilbert,dims=None,weights=None):
    """Converts a state vector in the Focker-Planck space to a density matrix.

    In the Focker-Planck space, the state vector is a vector of concatenated state vectors in Hilber space (pure quantum states) or vectorized density matrices (mixed quantum states).
    
    :param v: State vector in the Focker-Planck space.
...
def dm_to_focker(rho,dof,try_ket=True):
    """Copies a density matrix to a state vector in the Focker-Planck space.

    In the Focker-Planck space, the state vector is a vector of concatenated state vectors in Hilbert space (pure quantum states) or vectorized density matrices (mixed quantum states).
